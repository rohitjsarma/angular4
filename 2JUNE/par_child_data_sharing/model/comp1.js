...
var cls1 = /** @class */ (function () {
    ...
    cls1 = __decorate([
        core_1.Component({ selector: "s1", templateUrl: "views/view1.html" })
    ], cls1);
    return cls1;
}());
var cls2 = /** @class */ (function () {
    ...
    __decorate([
        core_1.Input()
    ], cls2.prototype, "x", void 0);
    __decorate([
        core_1.Input()
    ], cls2.prototype, "y", void 0);
    cls2 = __decorate([
        core_1.Component({ selector: "s2", templateUrl: "views/view2.html" })
    ], cls2);
    return cls2;
}());
