...
var myanimations = [
    animations_1.trigger("animation1", [
        animations_1.state("vis", animations_1.style({ top: "100px" })),
        animations_1.state("invv", animations_1.style({ top: "-550px" })),
        animations_1.transition("vis <=> invv", animations_1.animate("1000ms"))
    ])
];
